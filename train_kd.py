...
from utils.loss import ComputeLoss, compute_kd_output_loss, feature_loss, wat_loss, EFTLoss, CDLoss, CD_DS
...
def parse_opt(known=False):
    ...
    parser.add_argument('--name', default='l-s-kd-eft', help='save to project/name')
